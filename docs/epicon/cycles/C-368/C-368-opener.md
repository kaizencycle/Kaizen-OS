# C-368 Opener — Seven Optimizations
...
| 7 | C368-PR7_reserve-canon-prime.md | Terminal + Substrate | Prime cold canon — 349 Reserve Blocks → `canon/reserve-blocks/` | EP-3 | **after PR 2** |
| 3 | C368-PR3_epicon-cc0.md | epicon | Ratify CC0; resolve AGPL self-contradiction | EP-2 | 4 — quick |
| 4 | C368-PR4_epicon-api-truthful-health.md | epicon | Truthful /health, manifest, discoverable source | EP-2/3 | 3 — small |
...
**Suggested order:** 1 → 2 → **7** (recorded-history debt) → 4 → 3 → 6 → 5 (App work fills the rest of the cycle).
...
GI display drift on terminal (0.78 header vs 0.74 vault panel — rider on PR 7).
