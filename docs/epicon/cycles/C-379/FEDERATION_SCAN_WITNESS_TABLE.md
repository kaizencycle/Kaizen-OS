...
| Wallet | `GET mobius-mic-wallet-service.onrender.com/health` | `status:ok`, `db_ok:true`, `db_write_ok:true`, `disk_mounted:true` @ 2026-07-21T23:09:47Z | **TRUE — connectivity + mount** (durability redeploy test **BLOCKING**) |
