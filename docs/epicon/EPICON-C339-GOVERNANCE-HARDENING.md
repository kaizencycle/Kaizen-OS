...
| 13 | Catalog auto-regen instead of post-hoc failure | ✅ Implemented — same-repo PRs get a bot commit `chore(catalog): regenerate catalog [skip ci]`; failing check retained as backstop for forks and pushes |
