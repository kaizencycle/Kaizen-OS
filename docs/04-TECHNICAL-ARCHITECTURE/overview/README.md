...
- **[System Overview](./system-overview.md)** (to be created)
  High-level architecture of Mobius Systems
...
- **[Kaizen Bridge Architecture](./technical/kaizen_bridge_arch.md)**
  Integration layer and bridge patterns

- **[Living Interface Layer](./technical/living_interface_layer.md)**
  Dynamic interface and adaptation mechanisms

- **[Beyond Context Window](./technical/beyond_context_window.md)**
  Memory and context management strategies

### Additional Technical Docs
See [technical/](./technical/) directory for all architecture documents.

## 📊 Diagrams

Visual representations of system architecture:
- [diagrams/](./diagrams/) - System diagrams, flowcharts, architecture visuals
...
- [Whitepapers](../01-whitepapers/) - Economic architecture
- [Specifications](../06-specifications/) - Technical specs
- [Deployment Guides](../04-guides/deployment/) - How to deploy

## 📚 For Developers

Architecture docs help you:
...
- C4 model principles where applicable
