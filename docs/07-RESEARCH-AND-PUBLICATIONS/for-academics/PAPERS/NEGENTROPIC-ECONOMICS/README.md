...
**Properties:**
- Mints from order creation, not scarcity
- Inflation-resistant (supply tied to value)
...
Drawing from Schrödinger (1944):
- Living systems import negentropy
- Institutions create order
- Order reduces uncertainty
- Reduced uncertainty lowers interest
