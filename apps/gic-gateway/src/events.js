...
export function makeResolveCache() {
  return new LRUCache({ max: 1000, ttl: 60 * 1000 });
}

export function verifyHmac(body, sig, secret) {
  if (!sig) return false;
...
export function registerNewPostRoute(app, registry, cache) {
